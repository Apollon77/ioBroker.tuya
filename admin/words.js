...
systemDictionary = {
    ...
    "ProxyInfoText": {
        "en": "Because of changes from Tuya the proxy sync is only possible with Tuya (or compatible Apps) < 3.14 . For instructions using Android simulator please see the <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">GitHub infos</a>.",
        "de": "Aufgrund von Änderungen von Tuya ist die Proxy-Synchronisierung nur mit Tuya (oder kompatiblen Apps) <3.14 möglich. Anweisungen zur Verwendung des Android-Simulators finden Sie in den <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">GitHub-Infos</a>.",
        "ru": "Из-за изменений в Tuya синхронизация прокси возможна только с Tuya (или совместимыми приложениями) <3.14. Инструкции по использованию симулятора Android см. В информации о <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">GitHub</a>.",
        "pt": "Devido a alterações no Tuya, a sincronização de proxy só é possível com o Tuya (ou aplicativos compatíveis) <3.14. Para obter instruções sobre o simulador do Android, consulte as <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">informações do GitHub</a>.",
        "nl": "Vanwege wijzigingen in Tuya is de proxy-synchronisatie alleen mogelijk met Tuya (of compatibele apps) <3.14. Raadpleeg de <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">GitHub-informatie</a> voor instructies over het gebruik van Android-simulator.",
        "fr": "En raison des modifications apportées à Tuya, la synchronisation du proxy n'est possible qu'avec Tuya (ou des applications compatibles) <3.14. Pour obtenir des instructions sur l'utilisation du simulateur Android, consultez les <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">informations GitHub</a>.",
        "it": "A causa delle modifiche da Tuya, la sincronizzazione proxy è possibile solo con Tuya (o app compatibili) <3.14. Per istruzioni sull'uso del simulatore Android, consultare le <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">informazioni su GitHub</a>.",
        "es": "Debido a los cambios de Tuya, la sincronización de proxy solo es posible con Tuya (o aplicaciones compatibles) <3.14. Para obtener instrucciones sobre cómo usar el simulador de Android, consulte la <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">información de GitHub</a>.",
        "pl": "Ze względu na zmiany wprowadzone w Tuya synchronizacja proxy jest możliwa tylko z Tuya (lub zgodnymi aplikacjami) <3.14. Aby uzyskać instrukcje dotyczące korzystania z symulatora Androida, zobacz <a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">informacje na temat GitHub</a>.",
        "zh-cn": "由于Tuya的更改，代理同步仅适用于<3.14的Tuya（或兼容的Apps）。有关使用Android模拟器的说明，请参阅<a href=\"https://github.com/Apollon77/ioBroker.tuya/blob/master/PROXY.md#detailed-step-by-step-guide-for-using-proxy-with-android-and-older-app-version\" target=\"_blank\">GitHub</a>信息。"
    }
};
