...
systemDictionary = {
    ...
    "Proxy-Info": {
        "en": "To be able to get realtime status updates and to control devices you need to sync then with the mobile App where the devices are registered (e.g. Smart Life). This is done by using the Adapter Web-Proxy in your WLAN connection together with a SSL certificate. More Information in <a href=\"\" target=\"_blank\">README</a><br/><br/>Close/Kill the Tuya App. Start the proxy with the button below and follow the additional instructions.",
        "de": "Um Echtzeit-Status-Updates zu erhalten und Geräte zu steuern, müssen Sie diese mit der mobilen App synchronisieren, in der die Geräte registriert sind (z. B. Smart Life). Dazu verwenden Sie den Adapter-Web-Proxy in Ihrer WLAN-Verbindung zusammen mit einem SSL-Zertifikat. Weitere Informationen finden Sie in <a href=\"\" target=\"_blank\"> README </a> <br/> <br/> Schließen / Beenden Sie die Tuya App. Starten Sie den Proxy mit der Schaltfläche unten und folgen Sie den weiteren Anweisungen.",
        "ru": "Чтобы получать обновления статуса в реальном времени и управлять устройствами, вам необходимо синхронизировать их с мобильным приложением, где регистрируются устройства (например, Smart Life). Это делается с помощью веб-прокси адаптера в вашем WLAN-соединении вместе с сертификатом SSL. Дополнительная информация в <a href=\"\" target=\"_blank\"> README </a> <br/> <br/> Закрыть / Убить приложение Tuya. Запустите прокси с помощью кнопки ниже и следуйте дополнительным инструкциям.",
        "pt": "Para poder obter atualizações de status em tempo real e controlar dispositivos, é necessário sincronizar com o aplicativo móvel no qual os dispositivos estão registrados (por exemplo, Smart Life). Isso é feito usando o Adaptador Web Proxy em sua conexão WLAN junto com um certificado SSL. Mais informações em <a href=\"\" target=\"_blank\"> LEIA-ME </a> <br/> <br/> Fechar / Matar o aplicativo Tuya. Inicie o proxy com o botão abaixo e siga as instruções adicionais.",
        "nl": "Om realtime statusupdates te krijgen en apparaten te kunnen bedienen, moet u deze synchroniseren met de mobiele app waarop de apparaten zijn geregistreerd (bijvoorbeeld Smart Life). Dit gebeurt met behulp van de Adaptor Web-Proxy in uw WLAN-verbinding samen met een SSL-certificaat. Meer informatie in <a href=\"\" target=\"_blank\"> README </a> <br/> <br/> De Tuya-app sluiten / sluiten. Start de proxy met de onderstaande knop en volg de aanvullende instructies.",
        "fr": "Pour pouvoir obtenir des mises à jour de statut en temps réel et contrôler des appareils, vous devez vous synchroniser ensuite avec l'application mobile sur laquelle les appareils sont enregistrés (par exemple, Smart Life). Pour ce faire, utilisez Adapter Web-Proxy dans votre connexion WLAN avec un certificat SSL. Plus d'informations dans <a href=\"\" target=\"_blank\"> LISEZMOI </a> <br/> <br/> Fermez / éliminez l'application Tuya. Démarrez le proxy avec le bouton ci-dessous et suivez les instructions supplémentaires.",
        "it": "Per poter ottenere aggiornamenti dello stato in tempo reale e controllare i dispositivi, è necessario sincronizzarsi con l'app mobile in cui sono registrati i dispositivi (ad es. Smart Life). Questa operazione viene eseguita utilizzando il proxy Web dell'adapter nella connessione WLAN insieme a un certificato SSL. Ulteriori informazioni in <a href=\"\" target=\"_blank\"> README </a> <br/> <br/> Chiudi / uccidi l'app Tuya. Avvia il proxy con il pulsante in basso e segui le istruzioni aggiuntive.",
        "es": "Para poder obtener actualizaciones de estado en tiempo real y controlar los dispositivos, debe sincronizarlos luego con la aplicación móvil donde se registran los dispositivos (por ejemplo, Smart Life). Esto se hace utilizando el adaptador web-proxy en su conexión WLAN junto con un certificado SSL. Más información en <a href=\"\" target=\"_blank\"> README </a> <br/> <br/> Cierre / mate la aplicación Tuya. Inicie el proxy con el botón de abajo y siga las instrucciones adicionales.",
        "pl": "Aby móc uzyskać aktualizacje statusu w czasie rzeczywistym i kontrolować urządzenia, które należy zsynchronizować, a następnie z aplikacją mobilną, w której są zarejestrowane urządzenia (np. Smart Life). Odbywa się to za pomocą adaptera Web-Proxy adaptera w połączeniu WLAN z certyfikatem SSL. Więcej informacji w <a href=\"\" target=\"_blank\"> README </a> <br/> <br/> Zamknij / Kill the Tuya App. Uruchom proxy za pomocą przycisku poniżej i postępuj zgodnie z dodatkowymi instrukcjami."
    },
    "Proxy Port": {
        "en": "Proxy Port",
        "de": "Proxy-Port",
